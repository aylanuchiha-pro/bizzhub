...
export const M = {
  ...
  prod: {
    from: r => ({ id: r.id, bizId: r.biz_id, name: r.name, category: r.category, buyPrice: r.buy_price, sellPrice: r.sell_price, stock: r.stock, unit: r.unit, description: r.description || "", image: r.image || null, images: r.images || [], size: r.size || "", sizes: r.sizes || null, deletedAt: dt(r.deleted_at) }),
    to: (o, uid) => ({ id: o.id, user_id: uid, biz_id: o.bizId, name: o.name, category: o.category, buy_price: o.buyPrice, sell_price: o.sellPrice, stock: o.stock, unit: o.unit, description: o.description, image: o.image, images: o.images || [], size: o.sizes ? null : (o.size || null), sizes: o.sizes || null, deleted_at: iso(o.deletedAt) }),
  },
  sale: {
